...
<body>
            ...
            <nav class="navbar navbar-expand-sm navbar-light bg-light">
                ...
                <div class = "ms-auto">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link Sombreado Sombreado-Dos Tipo-Letra-Tamaño" href="formulario.html">FORMULARIO</a></li>
                    </ul>
                </div>
            </nav>
        </div>
    ...
    <main class="contenedor">
        ...
        <div class="contendor-estetica">
            ...
            function AgregarDatosArchivo($nombre, $correo, $telefono)
                {
                    try {
                ...
                try{
                    ...
                    AgregarDatosArchivo($_POST['nombre-completo'], $_POST['correo'], $_POST['telefono']);
                } catch (\Throwable $th) {
